import { WAMessage, delay } from "whaileys";
...
const SendWhatsAppMessage = async ({
  ...
  if (contactNumber.number && contactNumber.number !== "" && !ticket.isGroup) {
    number = `${contactNumber.number}@s.whatsapp.net`;
  } else if (contactNumber.remoteJid && contactNumber.remoteJid !== "" && contactNumber.remoteJid.includes("@")) {
