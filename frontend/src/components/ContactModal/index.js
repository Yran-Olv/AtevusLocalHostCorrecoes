...
const useStyles = makeStyles((theme) => ({
  ...
  switchInputCustom: {
    width: '300% !important',  // Aplicar o estilo específico ao input
  },
  textField: {
...
const ContactModal = ({ open, onClose, contactId, initialValues, onSave }) => {
  ...
  // Função para alternar o estado do switch e verificação com console.log
  const handleSwitchChange = () => {
    console.log("Switch clicked, current state:", disableBot);
    setDisableBot((prevState) => {
  ...
  return (
    <div className={classes.root}>
		{console.log("ContactModal component is rendering")}
      <Dialog open={open} onClose={handleClose} maxWidth="lg" scroll="paper" disableEnforceFocus>
              ...
              <DialogContent dividers>
                ...
                <Typography style={{ marginBottom: 8, marginTop: 12 }} variant="subtitle1">
                  <Switch
                    ...
                    name="disableBot"
					color="primary"
					classes={{ input: classes.switchInputCustom }}  // Aplica a classe personalizada ao input
                  />
