          ...
          >
            {({ touched, errors, isSubmitting, values, setFieldValue }) => (
              <Form className="multivus-form">
                ...
                <div className={`input-wrapper ${focusedFields.companyName || (touched.companyName && !errors.companyName) ? 'focused' : ''} ${values.companyName ? 'has-value' : ''} ${touched.companyName && errors.companyName ? 'error' : touched.companyName && !errors.companyName && values.companyName ? 'success' : ''}`}>
                ...
                <div className={`input-wrapper ${focusedFields.name || (touched.name && !errors.name) ? 'focused' : ''} ${values.name ? 'has-value' : ''} ${touched.name && errors.name ? 'error' : touched.name && !errors.name && values.name ? 'success' : ''}`}>
                  <div className="input-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className={`input-wrapper ${focusedFields.email || (touched.email && !errors.email) ? 'focused' : ''} ${values.email ? 'has-value' : ''} ${touched.email && errors.email ? 'error' : touched.email && !errors.email && values.email ? 'success' : ''}`}>
                  <div className="input-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className={`input-wrapper ${focusedFields.password || (touched.password && !errors.password) ? 'focused' : ''} ${values.password ? 'has-value' : ''} ${touched.password && errors.password ? 'error' : touched.password && !errors.password && values.password ? 'success' : ''}`}>
                  <div className="input-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className={`input-wrapper ${focusedFields.phone || (touched.phone && !errors.phone) ? 'focused' : ''} ${values.phone ? 'has-value' : ''} ${touched.phone && errors.phone ? 'error' : touched.phone && !errors.phone && values.phone ? 'success' : ''}`}>
                  <div className="input-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className={`input-wrapper select-wrapper ${focusedFields.planId || (touched.planId && !errors.planId) ? 'focused' : ''} ${values.planId ? 'has-value' : ''} ${touched.planId && errors.planId ? 'error' : touched.planId && !errors.planId && values.planId ? 'success' : ''}`}>
                  <div className="input-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
