    ...
    translations: {
      ...
      contactModal: {
        ...
        form: {
          ...
          extraValue: "Valor",
          chatBotContact: "Suspender chatbot",
      ...
      mainDrawer: {
        listItems: {
          ...
          chatsTempoReal: "Painel de Tickets",
          ...
          reports: "Relatórios",
          management: "Visão Geral",
          todoList: "Lembretes",
          flowBuilder: "Flowbuilder",
          phraseLists: "Fluxo Programado",
          flowChat: "Chatbot"
        },
        appBar: {
          user: {
      ...
      messagesList: {
        header: {
          ...
          buttons: {
            ...
            requiredTag: "Você deve atribuir uma etiqueta antes de fechar o ticket.",
          },
        },
      },
      messagesInput: {
      ...
      contactDrawer: {
        ...
        extraInfo: "Informações",
        phExtraInfoA: "Nenhuma informação,",
        phExtraInfoB: "clique em adicionar.",
      },
